    ...
    >
      ...
      <div className="flex-1 text-left max-w-2xl space-y-4 relative z-10">
        <div className="space-y-4">
          ...
          >
            <span className="block">Muhammad Amaan</span>
          ...
          >
            Aspiring Data Analyst turning raw data into clear, actionable insight through Python, SQL, Power BI, and Excel.
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="flex items-center gap-6 sm:gap-5 pt-2 sm:pt-0">
            ...
            <a
              ...
              title="GitHub"
            >
              <Github size={26} strokeWidth={2.2} />
            </a>
            <a
              ...
              title="LinkedIn"
            >
              <Linkedin size={26} strokeWidth={2.2} />
            </a>
          </div>
        </motion.div>
      </div>

        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          >
            <h3 className="text-3xl md:text-5xl font-black leading-tight text-white tracking-tighter">
              Let’s talk about <span className="text-blue-600 text-glow">data</span>.
            </h3>

            <p className="text-lg md:text-2xl text-zinc-400 font-medium max-w-md leading-relaxed">
              Open to Data Analyst opportunities, or just a good conversation about data.
            </p>
            ...
            {contactItems.map(({ icon: Icon, label, value, href }, i) => {
              ...
              return (
                <CardComponent
                  ...
                  className="group p-5 rounded-3xl border border-white/5 bg-white/[0.02] hover:border-blue-500/30 hover:bg-white/[0.04] hover:-translate-y-1 hover:shadow-lg transition-all duration-500 flex items-center gap-5 w-full cursor-pointer"
                >
                  ...
                  <div className="flex-1 flex flex-col items-start text-left">
                    <p className="font-black text-zinc-500 uppercase tracking-widest text-[10px]">
                      {label}
                    </p>
                  </div>

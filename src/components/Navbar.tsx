...
const Navbar = ({ terminalMode, setTerminalMode, uiType, setUiType }: Props) => {
  ...
  useEffect(() => {
    fetch("https://api.github.com/repos/MuhammadAmaan178/PortFolio")
      .then((res) => res.json())
      .then((data) => {
      ...
      <div className={`mx-auto transition-all duration-500 ${terminalMode ? "max-w-full px-0 mt-2" : "max-w-7xl px-2 sm:px-4 lg:px-6"
        ...
        >
          ...
          >
            ...
            <div className="relative">
              <span className="font-black text-2xl tracking-tighter uppercase text-white flex items-baseline">
                M.<span className={`text-[17px] ml-0.5 transition-colors ${terminalMode ? "text-zinc-500 group-hover:text-green-500" : "text-zinc-500 group-hover:text-blue-500"}`}>Amaan</span>
              </span>
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href="https://github.com/MuhammadAmaan178/PortFolio"
              target="_blank"
